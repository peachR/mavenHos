...
<body>
	...
	<div class="register-box">
		...
		<div class="register-box-body">
			<p id="news" class="login-box-msg">修改密码</p>
			<form id="changePasswordFrm">      			
      			...
      			<div class="form-group has-feedback">
      				...
      				<span class="glyphicon glyhicon-lock form-control-feedback"></span>
      			</div>
      			<div class="form-group has-feedback">
      			...
      			<div class="row">    	
      				<div class="col-sm-4"></div>			
        				<div class="col-sm-4">
          				<input id="sureChange" type="button" class="btn btn-primary btn-block btn-flat" value="确认修改" />
        				</div>
        				<!-- /.col -->
      			</div>
      			<a href="/mavenHos">返回登录</a>
    			</form>
		</div>
	...
	<script type="text/javascript" src="/mavenHos/scripts/MainScripts/changePasswordJs.js"></script>
</body>
</html>