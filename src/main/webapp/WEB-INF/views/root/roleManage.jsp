...
<!-- Tell the browser to be responsive to screen width -->
  ...
  <link rel="stylesheet" href="/mavenHos/Css/RootCss/roleManage.css" />
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
              <img src="/mavenHos/AdminLTE/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="/mavenHos/AdminLTE/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a id="changeLoginRole" href="/mavenHos/user/changeRole" class="btn btn-default btn-flat">切换角色</a>
                </div>
...
<aside class="main-sidebar">
    ...
    <section class="sidebar" style="height: auto;">
      ...
      <ul id="menu" class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
              <li class="active"><a href="/mavenHos/user/roleManage"><i class="fa fa-circle-o"></i> 角色信息</a></li>
  ...
  <!-- Bootstrap 3.3.6 -->
  <script src="/mavenHos/AdminLTE/bootstrap/js/bootstrap.min.js"></script>
  <!-- AdminLTE App -->
  <script src="/mavenHos/AdminLTE/dist/js/app.min.js"></script>
  <!-- main js -->
  <script src="/mavenHos/scripts/Root/roleManage.js"></script>
</html>